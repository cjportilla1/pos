      ...
      <div class="col-sm-8 mx-auto">
        <div class="p-5">
          <div class="text-center">
            <h1 class="h4 text-gray-900 mb-4">Administrar usuarios</h1>
          </div>
          <form class="user" id="frmAdminUsers">
            ...
            <a href="#0" id="registroUser" class="btn btn-primary btn-user btn-block text-white">
              Editar usuario
            </a>
            <hr>
          ...
          if (isset($_GET['eliminar'])) {
            ...
            $sqlDelete = "delete from usuarios where id_usuario='".$_GET['id']."'";
          ...
          if ($exe->num_rows > 0) {
            ...
            while ($res=$exe->fetch_row()) {
              ...
              echo "<a href='#0' class='btn btn-danger btn-sm' onclick='confirmDelete($res[0]);'>Eliminar usuario</button>
                </td>
              </tr>";
  ...
  <script type="text/javascript">
    $(document).ready(function() {
      $('#registroUser').click(function() {
       ...
       vacios= validarFormVacio('frmAdminUsers')
