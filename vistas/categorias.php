...
<div class="card o-hidden border-0 shadow-lg my-5">
      ...
      <div class="col-sm-8 mx-auto">
        <div class="p-5">
          <div class="text-center">
            <h1 class="h4 text-gray-900 mb-4">Crear categoría</h1>
          </div>
          <form class="user" id="frmRegistroct">
            <div class="form-group row">
              <div class="col-sm mb-3 mb-sm-0">
                <input type="text" class="form-control form-control-user" name="NombreCt" id="exampleFirstName" placeholder="Nombre">
              </div>
            ...
            <a href="#0" id="registroct" class="btn btn-primary btn-user btn-block text-white">
              Registrar categoría
            </a>
            <hr>
            <a href="index.php" class="btn btn-google btn-user btn-block">
              <i class="fab fa-arrow-alt-circle-left fa-fw"></i> Regresar a la pagina principal
            </a>
  ...
  <script type="text/javascript">
    $(document).ready(function() {
      $('#registroct').click(function() {


       vacios= validarFormVacio('frmRegistroct')
        ...
        datos = $('#frmRegistroct').serialize();
        $.ajax({
          type: "POST",
          data: datos,
          url: "../procesos/regCat/regCate.php",
          success: function(r) {
...
{ 
  ...
  alertify.success('Exito al guardar la categoría!');
